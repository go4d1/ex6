...
EXE_FILE		  =		  	"Es6"
DCOM_ProgId       =			"Es6.Es6Server"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Es6/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Es6/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Es6/wc.wc?wwmaint~FileUpload"
