...
***            Es6.exe "config"
***            Es6.exe "config" "IIS://localhost/w3svc/21/root"
************************************************************************
...
IF VARTYPE(lcAction) = "C" AND StartsWith(LOWER(lcAction),"config")
         do Es6_ServerConfig.prg with lvParm1
      RETURN 
ENDIF

*** Load the server - wc3DemoServer class below
goWCServer = CREATE("Es6Server")
...
IF llAutoRestart
   LiveReloadShutdown("DO Es6Main.prg")
ELSE
...
**************************************************************
DEFINE CLASS Es6Server AS WWC_SERVER OLEPUBLIC
*************************************************************
...
*** THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Es6.ini"
...
THIS.oConfig = CREATEOBJECT("Es6Config")
...
***************************************************************
DEFINE CLASS Es6Config AS wwServerConfig
***************************************************************
*: Author: Rick Strahl
...
THIS.oaJS = CREATEOBJECT("aJSConfig")
...
cHTMLPagePath = "c:\WebConnectionProjects\es6\Web\"
cDATAPath = ".\"
cVirtualPath = "/es6/"
...
*** Configuration class for the aJS Process class
DEFINE CLASS aJSConfig as wwConfig
